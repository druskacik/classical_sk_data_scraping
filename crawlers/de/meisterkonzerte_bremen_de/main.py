...
SOURCE_URL = 'https://www.meisterkonzerte-bremen.de/de'
EVENTS_API_URL = f'{SOURCE_URL}/api/productions/'
SOURCE = 'Meister Konzerte Bremen'
CITY = 'Bremen'
...
def get_concerts():
    ...
    # This early date makes the API include all concerts retained in its archive.
    url = EVENTS_API_URL
...
class MeisterkonzerteBremenDeCrawler(BaseCrawler):
    config = CrawlerConfig(
        slug='meisterkonzerte_bremen_de',
        source=SOURCE,
        source_url=SOURCE_URL,
        country_code='DE',
...
def main():
    MeisterkonzerteBremenDeCrawler().run()
